...
fn help(){
    println!("Here's a list of all commands:");
    println!("-get_schedule <day>");
    println!("-add_pattern <day>");
    println!("-remove_pattern <day> <optional:name>");
    println!("-change_pattern <day> <optional:name>");
    println!("-clear_patterns <day>");
    println!("-copy_pattern <day> <optional:name>");
    println!("-paste_pattern <day(s)>");

    println!("(note: you can put 'today' in <day> and it will work)")
}
...
fn main() {
    ...
    sleep(Duration::new(0,milli_to_nano(500)));
    loop {
        sleep(Duration::new(0,milli_to_nano(100)));
    ...
    println!("{day_type:?}");
    Data::get_day(&pr,day_type).unwrap().present_patterns();
